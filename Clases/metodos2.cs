...
namespace Herramientas.Clases
{
    class metodos
    {
        ...
        /// <summary>
        /// Devuelve colores predeterminados Matrix Consulting {rojo,rojoOscuro,negro,gris,grisOcsuro,amarillo,negroBase}
        /// </summary>
        ...
        private void cargarValoresPorDefecto()
        {
            ...
            CONFIG.Add("Bllts_bulletFont_1", "Verdana");
            CONFIG.Add("Bllts_bulletFont_2", "Verdana");
            CONFIG.Add("Bllts_bulletFont_3", "Verdana");
            CONFIG.Add("Bllts_bulletChar_1", "0020");
            CONFIG.Add("Bllts_bulletChar_2", "45"); // 45
            CONFIG.Add("Bllts_bulletChar_3", "9642"); // 9642
            CONFIG.Add("Bllts_firstLineIndent_1", "-13");
            CONFIG.Add("Bllts_firstLineIndent_2", "-13");
            CONFIG.Add("Bllts_firstLineIndent_3", "-13");
            ...
            CONFIG.Add("Bllts_margin_16_Left_2", "" + (erIndet + 13));
            CONFIG.Add("Bllts_margin_16_Left_3", "" + (erIndet + 33));
            CONFIG.Add("Bllts_margin_14_Left_1", "" + (erIndet - float.Parse("9.5", CultureInfo.InvariantCulture)));
            CONFIG.Add("Bllts_margin_14_Left_2", "" + (erIndet + 12));
            CONFIG.Add("Bllts_margin_14_Left_3", "" + (erIndet + 32));
            CONFIG.Add("Bllts_margin_12_Left_1", "" + (erIndet - float.Parse("9.5", CultureInfo.InvariantCulture)));
            CONFIG.Add("Bllts_margin_12_Left_2", "" + (erIndet + 10));
            CONFIG.Add("Bllts_margin_12_Left_3", "" + (erIndet + 31));
            CONFIG.Add("Bllts_margin_11_Left_1", "" + (erIndet - float.Parse("9.5", CultureInfo.InvariantCulture)));
            CONFIG.Add("Bllts_margin_11_Left_2", "" + (erIndet + 9));
            CONFIG.Add("Bllts_margin_11_Left_3", "" + (erIndet + 29));
            ...
            CONFIG.Add("Highlight_label_left", "7.92");
            ...
            CONFIG.Add("Cajas_texto_width", "120");
            ...
            CONFIG.Add("Agenda_hora", "YES");
            CONFIG.Add("Agenda_portada", "NO"); 

            CONFIG.Add("Agenda_item_width", "617.76");
            CONFIG.Add("Agenda_item_height", "55");
            CONFIG.Add("Agenda_item_top", "33.12"); //113.76 - 50
            CONFIG.Add("Agenda_item_gapToNext", "80.64"); //194.4
            CONFIG.Add("Agenda_item_left", "50.4");
            ...
            //Easter eggs
            CONFIG.Add("ModoGeek", "0");
            CONFIG.Add("Alineacion_integ1", "0"); //Nico Palma
            CONFIG.Add("Alineacion_integ2", "0");
            CONFIG.Add("Alineacion_integ3", "0"); //R. Marino
            CONFIG.Add("Alineacion_integ4", "0"); //J. Domingo
            CONFIG.Add("Alineacion_integ5", "0"); //I. Fika
            CONFIG.Add("Alineacion_integ6", "0"); //J. Barten
            CONFIG.Add("Alineacion_integ7", "0"); //M.  Schlotfeldt
            CONFIG.Add("Alineacion_integ8", "0"); //A. Valenzuela
            CONFIG.Add("Alineacion_integ9", "0"); //Jaime Siles
            CONFIG.Add("Alineacion_integ10", "0"); //Jürgen Uhlmann
            CONFIG.Add("Alineacion_integ11", "0"); //Agustín Dagnino
            CONFIG.Add("Alineacion_integ12", "0"); //Gabriel Adriazola
            CONFIG.Add("Alineacion_integ13", "0"); //Andrés Oksemberg
            CONFIG.Add("Alineacion_integ14", "0"); 
            CONFIG.Add("Alineacion_integ15", "0"); //Jorge Marín
